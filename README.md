# Studio CAI – Deleghe per l'assemblea v1.1
...
Versione 1.1 del 23/09/2026 (vedi `CHANGELOG_v1.1.md`).
...
4. Tocca il riquadro della firma e firma con il dito nella finestra che si apre, poi "Conferma firma".
...
Stack: React 18 (CRA), Tailwind CSS 3, Framer Motion, Lucide React, jsPDF (il PDF si genera nel browser, senza servizi a pagamento). Il logo è in `public/logo.jpg`, lo stesso delle altre webapp dello studio (le email di Make usano ancora la copia pubblicata con Segnalazioni).
